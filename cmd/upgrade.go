...
func newChartCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: strings.Join([]string{
			...
			"",
			"  # Set HELM_DIFF_CHAR_LEVEL_HIGHLIGHT=true to",
			"  # enable character-level highlighting for better visibility of changes.",
			"  # This is equivalent to specifying the --char-level-highlight flag.",
			"  HELM_DIFF_CHAR_LEVEL_HIGHLIGHT=true helm diff upgrade my-release datadog/datadog",
			"",
